...
export const PRODUCTS: Product[] = [
  ...
  /* ── Ноутбуки — май 2026 ─────────────────────────────────────── */
  {
    id: "apple-macbook-pro-16-m5-max",
    name: "MacBook Pro 16\" M5 Max 48/1TB",
    slug: "apple-macbook-pro-16-m5-max",
    category: "noutbuki",
    brand: "Apple",
    price: 549990,
    badge: "Новинка",
    emoji: "💻",
    img: "/images/phones/macbook-pro-spaceblack.jpg",
    memories: ["1 ТБ SSD", "2 ТБ SSD"],
    colors: ["Space Black (Космический чёрный)", "Silver (Серебристый)"],
    inStock: true, rating: 5, reviewCount: 14,
    description: "MacBook Pro 16\" с чипом M5 Max — флагман для профессионалов: рендеринг, ML, 3D-графика без ограничений. 22-часовая автономность.",
    specs: [
      { key: "Дисплей",     val: "16.2\" Liquid Retina XDR, 3456×2234, 120 Гц" },
      { key: "Процессор",   val: "Apple M5 Max (16-ядерный CPU)" },
      { key: "GPU",         val: "40-ядерный GPU" },
      { key: "ОЗУ",         val: "48 ГБ unified memory" },
      { key: "Накопитель",  val: "1 ТБ SSD" },
      { key: "Автономность",val: "до 22 ч" },
      { key: "ОС",          val: "macOS Tahoe" },
    ],
  },
  {
    id: "apple-macbook-pro-14-m5-pro",
    name: "MacBook Pro 14\" M5 Pro 24/512GB",
    slug: "apple-macbook-pro-14-m5-pro",
    category: "noutbuki",
    brand: "Apple",
    price: 329990,
    badge: "Новинка",
    emoji: "💻",
    img: "/images/phones/macbook-pro-silver.jpg",
    memories: ["512 ГБ SSD", "1 ТБ SSD"],
    colors: ["Space Black (Космический чёрный)", "Silver (Серебристый)"],
    inStock: true, rating: 5, reviewCount: 21,
    description: "MacBook Pro 14\" M5 Pro — компактный профессиональный ноутбук с дисплеем Liquid Retina XDR и Thunderbolt 5. Идеален для разработчиков и дизайнеров.",
    specs: [
      { key: "Дисплей",     val: "14.2\" Liquid Retina XDR, 3024×1964, 120 Гц" },
      { key: "Процессор",   val: "Apple M5 Pro (12-ядерный CPU)" },
      { key: "GPU",         val: "20-ядерный GPU" },
      { key: "ОЗУ",         val: "24 ГБ unified memory" },
      { key: "Накопитель",  val: "512 ГБ SSD" },
      { key: "Автономность",val: "до 17 ч" },
      { key: "ОС",          val: "macOS Tahoe" },
    ],
  },
  {
    id: "apple-macbook-air-15-m4",
    name: "MacBook Air 15\" M4 16/512GB",
    ...
    badge: "Хит",
    emoji: "💻",
    img: "/images/phones/macbook-air-m4.jpg",
    memories: ["256 ГБ SSD", "512 ГБ SSD", "1 ТБ SSD"],
    ...
    description: "MacBook Air 15\" с чипом M4 — самый тонкий 15-дюймовый ноутбук. Беззвучная работа, до 18 часов автономности и поддержка двух внешних дисплеев.",
    specs: [
      { key: "Дисплей",     val: "15.3\" Liquid Retina, 2880×1864" },
      { key: "Процессор",   val: "Apple M4 (10-ядерный CPU)" },
      { key: "GPU",         val: "10-ядерный GPU" },
      { key: "ОЗУ",         val: "16 ГБ unified memory" },
      { key: "Накопитель",  val: "512 ГБ SSD" },
      { key: "Автономность",val: "до 18 ч" },
      { key: "ОС",          val: "macOS Tahoe" },
    ],
  },
  {
    ...
    description: "MacBook Air 13\" M4 — легчайший (1.24 кг), невероятно быстрый и бесшумный. Лучший выбор для студентов и специалистов.",
    specs: [
      { key: "Дисплей",     val: "13.6\" Liquid Retina, 2560×1664" },
      { key: "Процессор",   val: "Apple M4 (10-ядерный CPU)" },
      { key: "GPU",         val: "10-ядерный GPU" },
      { key: "ОЗУ",         val: "16 ГБ unified memory" },
      { key: "Накопитель",  val: "256 ГБ SSD" },
  ...
  /* ── Смарт-часы — май 2026 ────────────────────────────────────── */
  {
    ...
    category: "smart_chasy",
    brand: "Apple",
    price: 129990,
    badge: "Новинка",
    emoji: "⌚",
    img: "/images/phones/watch-ultra3.jpg",
    memories: ["64 ГБ"],
    colors: ["Natural Titanium (Натуральный титан)", "Black Titanium (Чёрный титан)"],
    inStock: true, rating: 5, reviewCount: 8,
    description: "Apple Watch Ultra 3 — самые прочные часы Apple с GPS двойного диапазона, батареей до 72 часов и дисплеем 2000 нит. Для экстремальных приключений.",
    specs: [
      { key: "Корпус",       val: "49 мм, титан класса 5" },
      { key: "Дисплей",      val: "2.2\" LTPO OLED, 2000 нит" },
      { key: "Чип",          val: "Apple S11" },
      { key: "GPS",          val: "Двойной L1+L5" },
      { key: "Автономность", val: "до 72 ч (обычный), до 60 ч (маршрут)" },
      { key: "Защита",       val: "IP6X, 100 м WR" },
      { key: "ОС",           val: "watchOS 12" },
    ],
  },
  {
    id: "apple-watch-s11-45",
    name: "Apple Watch Series 11 45mm",
    slug: "apple-watch-series-11-45mm",
    category: "smart_chasy",
    brand: "Apple",
    price: 59990,
    badge: "Новинка",
    emoji: "⌚",
    img: "/images/phones/watch-s11.jpg",
    memories: ["64 ГБ"],
    ...
    description: "Apple Watch Series 11 с чипом S11, двойным дисплеем и расширенным мониторингом здоровья. Самые умные часы Apple для повседневной жизни.",
    specs: [
      { key: "Корпус",       val: "45 мм, алюминий" },
      { key: "Дисплей",      val: "LTPO OLED, 2000 нит" },
      { key: "Чип",          val: "Apple S11" },
      { key: "GPS",          val: "L1+L5" },
      { key: "Автономность", val: "до 36 ч (обычный), до 72 ч (Low Power)" },
      { key: "Защита",       val: "IP6X, 50 м WR" },
      { key: "ОС",           val: "watchOS 12" },
    ],
  },
  {
    id: "apple-watch-s11-41",
    name: "Apple Watch Series 11 41mm",
    slug: "apple-watch-series-11-41mm",
    category: "smart_chasy",
    brand: "Apple",
    price: 49990,
    emoji: "⌚",
    ...
    colors: ["Rose Gold (Розовое золото)", "Midnight (Полночь)", "Starlight (Звёздный свет)", "Silver (Серебристый)"],
    inStock: true, rating: 5, reviewCount: 44,
    description: "Apple Watch Series 11 41mm — компактный вариант с теми же флагманскими функциями мониторинга здоровья и чипом S11.",
    specs: [
      { key: "Корпус",       val: "41 мм, алюминий" },
      { key: "Дисплей",      val: "LTPO OLED, 2000 нит" },
      { key: "Чип",          val: "Apple S11" },
      { key: "GPS",          val: "L1+L5" },
      { key: "Автономность", val: "до 36 ч (обычный), до 72 ч (Low Power)" },
  ...
  /* ── Планшеты — май 2026 ─────────────────────────────────────── */
  {
    ...
    name: "iPad Pro 13\" M5 Wi-Fi 256GB",
    ...
    badge: "Новинка",
    emoji: "📱",
    img: "/images/phones/ipad-pro.jpg",
    memories: ["256 ГБ", "512 ГБ", "1 ТБ", "2 ТБ"],
    colors: ["Space Black (Космический чёрный)", "Silver (Серебристый)"],
    inStock: true, rating: 5, reviewCount: 11,
    description: "iPad Pro 13\" с чипом M5 — непревзойдённая производительность в тонком корпусе 5.1 мм. OLED Ultra Retina XDR и поддержка Apple Intelligence.",
    specs: [
      { key: "Дисплей",     val: "13\" OLED Ultra Retina XDR, 2752×2064" },
      { key: "Процессор",   val: "Apple M5" },
      { key: "ОЗУ",         val: "16 ГБ" },
      { key: "Накопитель",  val: "256 ГБ" },
      { key: "Камера",      val: "12 Мп + 12 Мп Ultra Wide" },
      { key: "Подключение", val: "Wi-Fi 7, Bluetooth 5.3" },
      { key: "ОС",          val: "iPadOS 19" },
    ],
  },
  {
    id: "apple-ipad-pro-m5-11",
    name: "iPad Pro 11\" M5 Wi-Fi 256GB",
    slug: "apple-ipad-pro-11-m5-256gb",
    category: "planshety",
    brand: "Apple",
    price: 129990,
    badge: "Новинка",
    ...
    description: "iPad Pro 11\" M5 — мощнейший компактный планшет с OLED-дисплеем и Apple Intelligence. Корпус толщиной 5.3 мм.",
    specs: [
      { key: "Дисплей",     val: "11\" OLED Ultra Retina XDR, 2420×1668" },
      { key: "Процессор",   val: "Apple M5" },
      { key: "ОЗУ",         val: "16 ГБ" },
      { key: "Накопитель",  val: "256 ГБ" },
      { key: "Камера",      val: "12 Мп + 12 Мп Ultra Wide" },
  ...
  },
  {
    ...
    name: "iPad Air 13\" M3 Wi-Fi 256GB",
    slug: "apple-ipad-air-13-m3-256gb",
    category: "planshety",
    brand: "Apple",
    price: 99990,
    badge: "Хит",
    emoji: "📱",
    img: "/images/phones/ipad-air.jpg",
    memories: ["256 ГБ", "512 ГБ", "1 ТБ"],
    colors: ["Blue (Синий)", "Purple (Фиолетовый)", "Starlight (Звёздный свет)", "Space Gray (Серый космос)"],
    inStock: true, rating: 5, reviewCount: 28,
    description: "iPad Air 13\" с M3 — тонкий, лёгкий планшет с дисплеем Liquid Retina и поддержкой Apple Pencil Pro. Лучший выбор для продуктивности.",
    specs: [
      { key: "Дисплей",     val: "13\" Liquid Retina, 2732×2048, 264 ppi" },
      { key: "Процессор",   val: "Apple M3" },
      { key: "ОЗУ",         val: "8 ГБ" },
      { key: "Накопитель",  val: "256 ГБ" },
      { key: "Камера",      val: "12 Мп Wide" },
      { key: "Подключение", val: "Wi-Fi 6E, Bluetooth 5.3" },
      { key: "ОС",          val: "iPadOS 19" },
    ],
  },
  {
    id: "apple-ipad-air-m3-11",
    name: "iPad Air 11\" M3 Wi-Fi 256GB",
    slug: "apple-ipad-air-11-m3-256gb",
    category: "planshety",
    brand: "Apple",
    price: 79990,
    emoji: "📱",
    ...
    description: "iPad Air 11\" M3 — идеальный баланс мощности и мобильности. Чип M3 справится с любой задачей.",
    specs: [
      { key: "Дисплей",     val: "11\" Liquid Retina, 2360×1640, 264 ppi" },
      { key: "Процессор",   val: "Apple M3" },
      { key: "ОЗУ",         val: "8 ГБ" },
      { key: "Накопитель",  val: "256 ГБ" },
      { key: "Камера",      val: "12 Мп Wide" },
