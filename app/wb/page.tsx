...
export const metadata: Metadata = {
  ...
  description: `Купите любой товар с Wildberries в рассрочку по нормам Ислама. Без банка, без риба. ${COMPANY.legalName}, ${COMPANY.city}.`,
      ...
      >
        <div className="section text-center max-w-3xl mx-auto">
          ...
          <p className="text-white/80 text-base md:text-lg leading-relaxed mb-8 max-w-xl mx-auto">
            Любые товары с WB в рассрочку по нормам Ислама. Без банка, без риба, без пени.
...
const FAQ = [
  ...
  {
    q: "Чем это отличается от кредита?",
    a: "Финнайс работает по принципу товарной рассрочки — мы сначала покупаем товар, а потом продаём вам с фиксированной наценкой. Это не кредит и не займ, в сделке нет ссудного процента (риба).",
  },
  {
